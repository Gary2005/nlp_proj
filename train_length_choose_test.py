...
wandb.init(project="encoder_decoder", entity="tqx_wandb", name="embeddingmodel-1024")
...
length_penalty = torch.arange(len(length)).to(device).float()
...
for epoch in range(10):
    ...
    for batch in bar:
        ...
        if cnt % 2048 == 1:
            ...
            torch.save(eemodel.state_dict(), "/root/autodl-tmp/embeddingmodel_1024.pth")
