...
wandb.init(project="encoder_decoder", entity="tqx_wandb", name=f"embeddingmodel_flip_len_{args.len}_random_rate_{args.random_rate}")
...
for epoch in range(10):
    ...
    for batch in bar:
        ...
        if cnt % 2048 == 1:
            ...
            torch.save(eemodel.state_dict(), f"/root/autodl-tmp/embeddingmodel_flip_{args.len}_random_rate_{args.random_rate}.pth")
