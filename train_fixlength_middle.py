...
wandb.init(project="encoder_decoder", entity="tqx_wandb", name="middle_2048_16384")
...
for epoch in range(10):
	...
	for batch in bar:
		...
		if cnt % 2048 == 1:
			...
			print("output:", output)
			model.train()
			torch.save(model.state_dict(), "/root/autodl-tmp/truncate_transformer_2048_16384.pth")
