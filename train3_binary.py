...
class Transformer(nn.Module):
    def __init__(self, src_vocab_size, trg_vocab_size, src_pad_idx, trg_pad_idx, embed_size=256, num_layers=4, forward_expansion=4, heads=8, dropout=0.1, max_length=50, device="cuda", mid_embedding_size=2048, hidden_size=2048):
...
wandb.init(project="encoder_decoder", entity="tqx_wandb", name="train3_binary_sigmoid")
...
for epoch in range(10):
    ...
    for batch in bar:
        ...
        if cnt % 1024 == 1:
            ...
            print("output:", output)
            model.train()
            torch.save(model.state_dict(), "/root/autodl-tmp/train2_sigmoid.pth")
