...
wandb.init(project="encoder_decoder", entity="tqx_wandb", name="embeddingmodel_no_argmax")
...
for epoch in range(10):
    ...
    for batch in bar:
        ...
        if cnt % 2048 == 1:
            ...
            torch.save(eemodel.state_dict(), "/root/autodl-tmp/embeddingmodel_lengthcho_no_argmx.pth")
